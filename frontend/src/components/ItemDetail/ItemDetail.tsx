                ...
                <section className='item-detail__container'>
                    ...
                    <section className='item-detail__content'>
                        <section className='item-detail__info'>
                            <Picture src={context.data.itemDetail.item.picture} alt='' size={PictureSizes.large} />
                            <aside className='item-detail__aside'>
                                <ProductInfo condition={context.data.itemDetail.item.condition} sold={context.data.itemDetail.item.sold_quantity} title={context.data.itemDetail.item.title} price={context.data.itemDetail.item.price} />
                            </aside>
                        </section>
                        <section className='item-detail__description'>

                            <ProductDescription title='Descripción del producto' description={context.data.itemDetail.item.description} />
                        </section>
                    </section>
                </section>
            }
